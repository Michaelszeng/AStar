...
public class AStarAlgorithm {
    ...
    public ArrayList<Node> openNodes = new ArrayList<>();   //set of nodes to be evaluated
    public ArrayList<Node> closedNodes = new ArrayList<>(); //set of nodes already evaluated
